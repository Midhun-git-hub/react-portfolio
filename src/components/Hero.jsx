...
const Hero = () => {
    return (
        <section
            id="home"
            className="relative min-h-screen flex flex-col justify-center items-center text-center px-6 bg-neutral-950 text-white overflow-hidden"
        >
            ...
            <div className="relative z-10">
                ...
                <motion.div
                    ...
                    className="flex justify-center items-center gap-8 mt-8 text-2xl w-full"
                >
                    <a
